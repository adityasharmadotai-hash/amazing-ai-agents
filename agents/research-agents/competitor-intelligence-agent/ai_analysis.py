    ...
    def detect_product_launches(self, competitor_name):
        ...
        try:
            response = openai.ChatCompletion.create(
                model="gpt-4o",
                messages=[
                    {"role": "system", "content": "You are a product researcher. Return only JSON, no other text."},
                    {"role": "user", "content": prompt}
                ],
                max_tokens=500,
                temperature=0.3
    ...
    def analyze_pricing_changes(self, old_pricing, new_pricing, competitor_name):
        ...
        try:
            response = openai.ChatCompletion.create(
                model="gpt-4o",
                messages=[
                    {"role": "system", "content": "You are a pricing strategy analyst."},
                    {"role": "user", "content": prompt}
                ],
                max_tokens=200,
                temperature=0.7
    ...
    def analyze_hiring_patterns(self, job_data, competitor_name):
        ...
        try:
            response = openai.ChatCompletion.create(
                model="gpt-4o",
                messages=[
                    {"role": "system", "content": "You are an organizational strategy analyst."},
                    {"role": "user", "content": prompt}
                ],
                max_tokens=200,
                temperature=0.7
    ...
    def generate_competitive_summary(self, competitor_data):
        ...
        try:
            response = openai.ChatCompletion.create(
                model="gpt-4o",
                messages=[
                    {"role": "system", "content": "You are an executive competitive intelligence analyst. Be concise and actionable."},
                    {"role": "user", "content": prompt}
                ],
                max_tokens=300,
                temperature=0.7
    ...
    def generate_insight(self, description):
        ...
        try:
            response = openai.ChatCompletion.create(
                model="gpt-4o",
                messages=[
                    {"role": "system", "content": "You are a strategic advisor providing actionable insights."},
                    {"role": "user", "content": prompt}
                ],
                max_tokens=100,
                temperature=0.7
    ...
    def identify_threats(self, competitor_data):
        ...
        try:
            response = openai.ChatCompletion.create(
                model="gpt-4o",
                messages=[
                    {"role": "system", "content": "You are a strategic threat analyst. Identify real, actionable threats."},
                    {"role": "user", "content": prompt}
                ],
                max_tokens=400,
                temperature=0.7
    ...
    def get_market_positioning(self, competitor_name, market_context):
        ...
        try:
            response = openai.ChatCompletion.create(
                model="gpt-4o",
                messages=[
                    {"role": "system", "content": "You are a market strategy analyst with deep industry knowledge."},
                    {"role": "user", "content": prompt}
                ],
                max_tokens=400,
                temperature=0.7
